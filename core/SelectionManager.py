class SelectionManager:
    def __init__(self):
        ...
        self.tooltips_ajuda_mostrados = False  # Controla se os tooltips de ajuda já foram mostrados
    ...
    def marcar_tooltips_mostrados(self):
        #Marca que os tooltips de ajuda já foram mostrados
        self.tooltips_ajuda_mostrados = True
    
    def resetar_tooltips_ajuda(self):
        #Reseta os tooltips de ajuda para aparecerem novamente (usado quando novo grafo é importado)
        self.tooltips_ajuda_mostrados = False