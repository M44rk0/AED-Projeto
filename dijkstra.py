...
@dataclass
class DijkstraData:
    """Estrutura de dados para armazenar informações do algoritmo de Dijkstra."""
...
class Dijkstra:
    def __init__(self, grafo: Dict[int, Dict[int, float]]):
        ...
        Args:
            grafo: Grafo representado como dicionário de dicionários (lista de adjacência)
                  onde grafo[u][v] = peso da aresta (u,v)
        """
        self.grafo = grafo
        
    def encontrar_caminho(self, origem: int, destino: int) -> Tuple[List[int], float]:
        """
        Encontra o caminho mais curto entre origem e destino usando o algoritmo de Dijkstra.
        ...
        Returns:
            Tuple contendo o caminho (lista de vértices) e o custo total
        """
        dados = DijkstraData()
    ...
    def get_estatisticas(self) -> Dict[str, float]:
        ...
        Returns:
            Dicionário com tempo de execução, número de nós explorados e custo total
        """
